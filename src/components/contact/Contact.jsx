    ...
    >
        <motion.div className="textContainer" variants={variants} >
            ...
            <motion.div className="item" variants={variants}>
                <h2>Email</h2>
                <span>finjoseph433@gmail.com</span>
            </motion.div>

            <motion.div className="item" variants={variants}>
                <h2>Telephone</h2>
                <span>+261 34 47 933 33</span>
            </motion.div>

            <motion.div className="item" variants={variants}>
                <h2>Adresse</h2>
                <span>Lot 12N 381 Managrivotra Ouest Manakara 316 Madagascar</span>
            </motion.div>
        ...
        <svg width="800px" height="700px" viewBox="0 0 32.666 32.666">
